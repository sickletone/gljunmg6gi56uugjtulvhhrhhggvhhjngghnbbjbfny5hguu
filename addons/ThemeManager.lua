...
local ThemeManager = {} do
	...
	ThemeManager.BuiltInThemes = {
		...
		['Glass']			= { 13, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"23232a","AccentColor":"8ab4ff","BackgroundColor":"1c1c22","OutlineColor":"3a3a4a"}') },
		['Liquid Glass']	= { 14, httpService:JSONDecode('{"FontColor":"f5f5f7","MainColor":"1c1c1e","AccentColor":"0a84ff","BackgroundColor":"141416","OutlineColor":"38383a"}'), true }
	}
	...
	function ThemeManager:ApplyTheme(theme)
		...
		if self.Library.SetGlassEnabled then
			local isGlassTheme = (not customThemeData) and data[3] == true
			self.Library:SetGlassEnabled(isGlassTheme)
		end
		self:ThemeUpdate()
	end
